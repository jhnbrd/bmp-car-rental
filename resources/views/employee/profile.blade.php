                ...
                <div class="mb-4">
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="profile_picture" class="flex flex-col items-center justify-center w-full h-64 border-2 border-gray-300 border-dashed rounded-lg cursor-pointer bg-gray-50 dark:hover:bg-gray-800 dark:bg-gray-700 hover:bg-gray-100 dark:border-gray-600 dark:hover:border-gray-500 dark:hover:bg-gray-600">
                            ...
                            <input id="profile_picture" name="profile_picture" type="file" class="hidden" accept="image/*" required onchange="previewImage(this);"/>
                        </label>
                    </div>
                    <div class="mt-4">
                        <label id="preview-label" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white hidden" for="img-preview">Preview</label>
                        <img id="image-preview" src="#" alt="Uploaded Preview" class="hidden w-48 mx-auto h-auto rounded-lg shadow-md"/>
                    </div>
                </div>
                <div class="flex justify-end">
