      ...
      >
        ...
        <a class="flex flex-col items-center text-lg font-bold text-gray-800 dark:text-gray-200" href="#">
          ...
          <ul>
              ...
              <li class="relative px-6 py-3">
                  ...
                  <template x-if="isPagesMenuOpenVehicle">
                      <ul x-transition:enter="transition-all ease-in-out duration-300"
                          ...
                          <li class="px-2 py-1 transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200">
                              <a class="w-full" href="{{ route('damaged.cars') }}">
                                  Damaged Cars
                              </a>
                          </li>
                      </ul>
              ...
              @endif
              @if(Auth::user()->employee->role == 'Admin' || Auth::user()->employee->role == 'Manager' || Auth::user()->employee->role == 'Cashier')
              <li class="relative px-6 py-3">
                  <a class="inline-flex items-center w-full text-sm font-semibold transition-colors duration-150 hover:text-gray-800 dark:hover:text-gray-200"
              ...
              <li class="relative px-6 py-3 hidden">
                  ...
                  href="{{ url('/audit-logs') }}">
                      ...
                      <span class="ml-4">Audit Logs</span>
                  </a>
              </li>
              @endif
              <li class="relative px-6 py-3">
