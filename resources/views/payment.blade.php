...
<body class="font-sans h-screen w-full">
    ...
    <div class="bg-white-100 text-black/100 h-screen w-full flex flex-col">
        ...
        <main class="flex-1 mt-16">
            ...
            <section class="relative bg-[#0f1021] text-white py-2 text-center pb-15">
                <div class="py-5">
                ...
                <div class="flex flex-col mx-20 md:mx-40 flex-row items-start gap-5 rounded-lg shadow-lg">
                    <!-- Right Side: RENTAL AGREEMENT POLICY -->
                    <!-- rental agreement policy Section -->
                    <div class="w-full md:w-1/2 bg-white shadow-md rounded-lg p-6 max-h-[600px]">
                        <h1 class="text-2xl font-bold text-[#0f294c] mb-4 text-center">RENTAL AGREEMENT POLICY</h1>
                        <div class="bg-[#f9f9f9] rounded-lg shadow-lg p-6 mb-2 md:max-h-[500px] md:overflow-y-auto">
                    ...
                    <div
                        class="w-full md:w-1/2 bg-white shadow-md rounded-lg p-6 max-h-[601px] h-[601px] overflow-y-auto">
                        <h1 class="text-2xl font-bold text-[#0f294c] mb-4 text-center">BOOKING DETAILS</h1>
                        <!-- FOR SCROLLABLE-->
